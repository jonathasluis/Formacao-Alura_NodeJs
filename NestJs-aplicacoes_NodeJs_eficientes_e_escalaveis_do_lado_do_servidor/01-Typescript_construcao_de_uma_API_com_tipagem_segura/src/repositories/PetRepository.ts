...
export default class PetRepository implements InterfacePetRepository {
  ...
  async adotaPet(id: number, idAdotante: number): Promise<{ success: boolean; message?: string }> {
    try {
      ...
      return { success: false, message: "Ocorreu um erro ao tentar adotar o pet." };
    }
  }

  async buscaPetPeloCampoGenerico<Tipo extends keyof PetEntity>(campo: Tipo, valor: PetEntity[Tipo]): Promise<PetEntity[]> {
